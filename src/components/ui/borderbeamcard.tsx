...
// @ts-nocheck -- styles.ts below is an untyped CSS-generation utility module (ported verbatim); merged into one file for 21st.dev single-file publish constraints.
'use client'
...
// ---- BeamBorder component (from BorderBeam.tsx) ----
